...
public class ManageScreen extends JPanel {
    ...
    public ManageScreen(int x, int y, int width, int height) {
        ...
        this.titanicImage = new ImageIcon(Constants.TITANIC_IMAGE_PATH).getImage();
        playMusic();

    }
    private void playMusic(){
        this.music=new Music(Constants.BACKGROUND_MUSIC_PATH);
        this.music.play();
    }
    ...
    public void paintComponent(Graphics g) {
        ...
        g.drawImage(this.titanicImage,0,0,Constants.WINDOW_WIDTH,Constants.WINDOW_HEIGHT,this);
