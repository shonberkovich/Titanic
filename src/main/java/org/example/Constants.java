...
public class Constants {
    ...
    public static final String TITANIC_IMAGE_PATH = "src/main/java/org/example/resources/TitanicPhoneImage.jpeg";

    public static final String BACKGROUND_MUSIC_PATH="src/main/java/org/example/resources/14. My Heart Will Go On - Celine Dion.wav";
